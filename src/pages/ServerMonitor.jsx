  ...
  return (
    <div
      ...
      style={{
        ...
        background: "linear-gradient(160deg, #0e1012 0%, #0b0d0f 100%)",
        ...
        <div className="space-y-3">
          {isAdmin ? (
            ...
            <div
              ...
              style={{ border: `1px solid ${T.border}`, background: "linear-gradient(160deg, #0e1012 0%, #0b0d0f 100%)", minHeight: "200px" }}
            >
