...
const CAT_COLORS = { "Base Building": T.textDim, Crafting: T.amber, Survival: T.green, Weapons: T.red, Locations: T.cyan, Tactics: T.orange, Rules: "#b060ff", Other: T.textDim };
